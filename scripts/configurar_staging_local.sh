...
# Script para configurar entorno de staging local para CYH
# Crea una base de datos de prueba y configura el entorno

echo "🛠️  Configurando Entorno de Staging Local para CYH"
echo "=================================================="
echo ""
...
# 1. Crear base de datos de prueba si no existe
echo "🗄️  1. Configurando base de datos de prueba..."
DB_TEST="cyhfilament_test"

mysql -h127.0.0.1 -P3307 -uroot -p -e "CREATE DATABASE IF NOT EXISTS $DB_TEST;" 2>/dev/null

if [ $? -eq 0 ]; then
    echo "   ✅ Base de datos '$DB_TEST' creada/verificada"
else
...
# 4. Ejecutar migraciones en base de datos de prueba
echo ""
echo "🔄 4. Ejecutando migraciones en base de datos de prueba..."
